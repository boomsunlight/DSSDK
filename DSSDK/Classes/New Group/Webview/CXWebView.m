...
@interface CXWebView () <UIWebViewDelegate, WKNavigationDelegate, WKUIDelegate, CX_NJKWebViewProgressDelegate>
...
@property (nonatomic, strong) CX_NJKWebViewProgress* njkWebViewProgress;
@end
...
- (void)setDelegate:(id<CXWebViewDelegate>)delegate
{
    _delegate = delegate;
    if (_usingUIWebView) {
...
- (void)initUIWebView
{
    ...
    self.njkWebViewProgress = [[CX_NJKWebViewProgress alloc] init];
